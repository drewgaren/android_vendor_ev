...
# Apps
PRODUCT_COPY_FILES += \
    vendor/ev/prebuilt/common/app/com.teslacoilsw.launcher-1.apk:system/app/com.teslacoilsw.launcher-1.apk 
...
ifeq ($(NIGHTLY_BUILD),true)
    ROM_VERSION := FlyNEX-$(PRODUCT_CODENAME)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)-$(shell date +%Y%m%d)
else
    ROM_VERSION := FlyNEX-$(PRODUCT_CODENAME)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)
endif
